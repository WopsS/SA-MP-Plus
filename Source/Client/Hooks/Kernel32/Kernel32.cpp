...
void Hooks::Kernel32::Create()
{
	...
	// Note: 
	//		I did this way because if we will take a look at the function HUD::Draw() before SA-MP apply its hooks we should see:
	//				0053EB0D | E8 DE CD FC FF       | call gta_sa.50B8F0		|
	//				0053EB12 | E8 19 F7 FF FF		| call gta_sa.53E230		| call HUD::Draw
	...
	//				0053EB0D | E8 DE CD FC FF       | call gta_sa.50B8F0		|
	//				0053EB12 | E8 C9 4E 24 04		| call samp.47839E0			| call HUD::Draw (by SA-MP)
	//				0053EB17 | EB 65				| jmp gta_sa.53EB7E			|
	//		and in Game::Shutdown():
